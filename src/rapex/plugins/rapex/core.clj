(ns rapex.plugins.rapex.core
  (:require [rapex.plugins.rapex.boxplot :as boxplot]
            [rapex.plugins.rapex.boxplot-multiple-organs :as boxplot-multiple-organs]
            [rapex.plugins.rapex.barplot :as barplot]
            [rapex.plugins.rapex.barplot-multiple-organs :as barplot-multiple-organs]
            [rapex.plugins.rapex.corrplot :as corrplot]
            [rapex.plugins.rapex.heatmap :as heatmap]
            [ring.util.http-response :refer [ok not-found bad-request internal-server-error]]
            [rapex.db.query-data :as qd]
            [clojure.tools.logging :as log]
            [rapex.plugins.rapex.db-specs :as ds]
