export default {
  ...
  'menu.expression-analysis.kegg-pathways': 'KEGG Pathways',
  'menu.custom-analysis': 'Custom Analysis',
  'menu.custom-analysis.diff-genes': 'Differential Genes Table',
  'menu.custom-analysis.gene-expression-profile': 'Gene Expression Analysis',
